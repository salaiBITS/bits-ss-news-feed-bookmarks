...
LOCAL_APPS = [
    ...
    "news_feed_bookmarks.users.apps.UsersConfig",
]
...
MIGRATION_MODULES = {"sites": "news_feed_bookmarks.contrib.sites.migrations"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "News Feed Bookmarks API",
    "DESCRIPTION": "Documentation of API endpoints of News Feed Bookmarks",
    "VERSION": "1.0.0",
